...
class hr_holidays(osv.osv):
    ...
    _columns = {
        ...
        'state': fields.selection([('draft', 'To Submit'), ('cancel', 'Cancelled'),('confirm', 'Manager To Approve'), ('refuse', 'Refused'), ('validate1', 'HR to Approval'), ('validate', 'Approved')],
