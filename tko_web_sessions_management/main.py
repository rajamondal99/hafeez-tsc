                ...
                if multi_ok:
                    ...
                    if user.login_calendar_id:
                        ...
                        if attendances:
                            ...
                            unsuccessful_message = "'%s' is not allowed to login at this time" % \
                                                   login
                    else:
    ...
    def web_login(self, redirect=None, **kw):
        ...
        if request.httprequest.method == 'POST':
            ...
            if 'HTTP_X_FORWARDED_FOR' in request.httprequest.headers.environ and request.httprequest.headers.environ[
                ...
                forwarded_for = request.httprequest.headers.environ['HTTP_X_FORWARDED_FOR'].split(', ')
                if forwarded_for and forwarded_for[0]:
                    ip_address = forwarded_for[0]

            # From ../access_restriction_by_ip/controllers/main.py:51
            if request.params['login']:
                ...
                if user_rec.allowed_ips:
                    ...
                    if ip_address not in ip_list:
                        request.uid = old_uid
                        unsuccessful_message = "You are Not allowed to login from the IP"
            ...
            if access_granted:
                ...
                request.uid = old_uid
                values['error'] = _(unsuccessful_message)
