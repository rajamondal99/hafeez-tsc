...
# @ 2016 Kingsley Okonkwo <kingsleyuk2003@gmail.com, kingsley@kinsolve.com>
...
#            'period_id': invoice.period_id.id,
    ...
    def _merge_invoice_line_values(self, vals, new_invoice_line):
        ...
        :return: None
        """
        uom_factor = new_invoice_line.uom_id.factor or 1.0
        uos_factor = new_invoice_line.product_id.uom_id.factor or 1.0
            ...
            for field in fields:
                ...
                if (isinstance(field_val, browse_record) and
                   field != 'invoice_line_tax_ids'):
                    ...
                    list_key.append(('line_tax_ids', field_val))
