...
class stock_pack_operation(osv.osv):
    ...
    _columns = {
        ...
        'product_unit_price':fields.float('Cost Price',compute='_compute_unit_price'),
    ...
    def _compute_unit_price(self):
        for a in self:
	    print(a.product_id.standard_price)
            a.product_unit_price = a.product_id.standard_price
