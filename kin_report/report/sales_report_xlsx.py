...
class SalesReportWriter(ReportXlsx):
    ...
    def _get_data(self,form):
        ...
        if not end_date :
         ...
         # added by shon commision , fx rates in query
        sql_statement = """
            SELECT
    ...
    def generate_xlsx_report(self, workbook, data, objects):
        ...
        # added fx rate  and commsion  below  by shon
        sales_report_worksheet.write_row(row, col, ('S/N', 'Qty' , 'Customer', 'Order Date', 'Description','Unit Price' , 'Selling Price', 'Cost Price', 'Disc(%)', 'Disc. Amt.', 'Margin','Currency', 'Sales Person', 'Sales Order ID','Reference','Qty. To Invoice','Qty. Invoiced','Qty Delivered','FX Rates','Commision Value','Commission Amount') , head_format)
